<%@ Page Title="" Language="C#" MasterPageFile="~/Content/Master/Principal.master" AutoEventWireup="true" CodeFile="cancelarReserva.aspx.cs" Inherits="Paginas_Default3" %>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Cancelar Reserva</h3>

                    <div class="box-tools pull-right">
                        <asp:LinkButton ID="lbCheckIn" runat="server" CssClass="btn btn-facebook" OnClick="lbCheckIn_Click"><i class="fa fa-check-circle"></i> Cancelar</asp:LinkButton>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-12 col-sm-12">
                                <label for="txtMotivo">Motivo do Cancelamento</label>
