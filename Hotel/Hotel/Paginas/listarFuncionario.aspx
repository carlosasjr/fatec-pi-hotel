<%@ Page Title="" Language="C#" MasterPageFile="~/Content/Master/Principal.master" AutoEventWireup="true" CodeFile="listarFuncionario.aspx.cs" Inherits="Paginas_Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Funcionários
            <small>Controle de Funcionários</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            <br />
            <br />
            <asp:GridView ID="gdvFuncionario" CssClass="table table-hover table-success tabela" runat="server" AutoGenerateColumns="false" OnRowCommand="gdvFuncionario_RowCommand">
                <Columns>
