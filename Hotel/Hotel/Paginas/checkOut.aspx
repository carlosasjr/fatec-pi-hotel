<%@ Page Title="" Language="C#" MasterPageFile="~/Content/Master/Principal.master" AutoEventWireup="true" CodeFile="checkOut.aspx.cs" Inherits="Paginas_Default3" %>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <asp:LinkButton ID="lbCheckIn" runat="server" CssClass="btn btn-facebook" OnClick="lbCheckIn_Click"><i class="fa fa-check-circle"></i> Check-Out</asp:LinkButton>
